...
import { getWarehouseQueryString } from "@graphql/warehouse.graghql";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // fetch data
  const [assetData] = await Promise.all([getWarehouseAsset(locale as ILocale)]);
  ...
  return (
    <Fragment>
      ...
      <div id="pricing" className="container mx-auto">
        ...
        <PriceTable
          image={
            warehouseAsset?.attributes?.price_table?.price_image?.data
              ?.attributes?.url
          }
        />
