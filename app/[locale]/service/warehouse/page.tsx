...
const Warehouse = async () => {
  ...
  const [warehouseAsset, t] = await Promise.all([
    fetchAsset<IWarehouseAsset>("warehouse", locale as ILocale),
  ...
  return (
    <Fragment>
      <Banner image={warehouseAsset.bg_img} title={t("title")} />
        ...
        <div className="flex gap-24 mt-14 mb-28">
          <div className="basis-1/2">
            <div className="relative animation" data-animation-delay="0.4s">
              ...
              />
              <Image
                src={warehouseAsset.intro_sub_img}
                alt=""
                width={310}
                height={300}
          ...
          <div className="basis-1/2">
            ...
            >
              {warehouseAsset.description}
            </p>
            {warehouseAsset.features.map((txt, idx) => (
              <p
                key={idx}
