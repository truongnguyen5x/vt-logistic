...
const Reasons: FC<Props> = ({ className = "", assets }) => {
  ...
  return (
    <section className={clsx("relative bg-th-gray-250", className)}>
      ...
      <div className="container px-4 md:mx-auto py-10 md:py-20">
        <div className="flex items-center justify-start md:justify-center">
          <p className="section-name mb-6 animation max-md:after:left-16 max-md:text-left">
            {t("reason")}
          </p>
        </div>
        <p
        ...
        {!!assets?.reasons?.length && (
          <div
            className={clsx(
              ...
              "gap-y-6 md:gap-10 xl:gap-x-[150px] xl:gap-y-20",
              "mt-6 md:mt-[55px]"
            )}
