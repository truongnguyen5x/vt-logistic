    ...
    >
      <div
        className={clsx(
          ...
          "items-start lg:items-center xl:items-start",
      ...
      >
        ...
        <div>
          <p
            className={clsx(
              "section-name-left animation",
              "max-sm:after:left-0 max-sm:after:translate-x-0 max-lg:after:left-1/2 max-lg:after:-translate-x-1/2",
              "max-sm:text-left max-lg:text-center"
            )}
          >
            {t("core_values")}
          </p>
